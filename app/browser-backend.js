...
(function () {
  ...
  const BRIDGE_TOOLS = [
    ...
    { name: 'browser_open_tab', description: 'Open a new browser tab at a URL and return its tabId.', inputSchema: { type: 'object', properties: { url: { type: 'string' }, focus: { type: 'boolean' } }, required: ['url'] } },
    { name: 'browser_navigate', description: 'Navigate a tab (default: the active tab) to a URL.', inputSchema: { type: 'object', properties: { url: { type: 'string' }, tabId: { type: 'integer' } }, required: ['url'] } },
